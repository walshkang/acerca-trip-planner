...
export default function Omnibox({
  ...
  return (
    <div className="pointer-events-auto" ref={anchorRef}>
      <div className="glass-panel flex items-center gap-2 rounded-full px-3 py-2 md:rounded-[4px] md:border-paper-tertiary-fixed md:bg-paper-surface-container md:shadow-none md:backdrop-blur-none">
        <input
          className={`w-[min(520px,70vw)] bg-transparent text-sm outline-none md:font-body md:text-paper-on-surface md:placeholder:text-paper-on-surface-variant ${
            isDark
        ...
        {query ? (
          <button
            ...
            className="glass-button md:rounded-[4px] md:border md:border-paper-tertiary-fixed md:bg-paper-surface-container-low md:text-paper-on-surface md:shadow-none md:backdrop-blur-none hover:md:bg-paper-tertiary-fixed"
          >
            Clear
          </button>
        ) : null}
        <button
          ...
          className={`glass-button px-4 py-1.5 disabled:opacity-50 md:!rounded-[4px] md:!border-0 md:!bg-paper-primary md:!text-paper-on-primary md:shadow-none md:backdrop-blur-none md:font-bold md:uppercase md:text-xs md:tracking-widest hover:md:!bg-paper-primary-container ${
            isDark
