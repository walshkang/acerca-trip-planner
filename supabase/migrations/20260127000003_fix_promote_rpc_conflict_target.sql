-- Fix promote_place_candidate() ON CONFLICT target:
-- places_user_id_source_source_id_unique is a UNIQUE INDEX (partial), not a constraint.
-- Use index inference with a matching WHERE clause instead of ON CONFLICT ON CONSTRAINT.
